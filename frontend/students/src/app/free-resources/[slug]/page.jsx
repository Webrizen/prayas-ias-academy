...
export default function page({ params }) {
  const resourcess = resources.find(
  ...
  return (
    <>
      <section className="flex-1 -z-[99999]">
        <div className="container mx-auto grid grid-cols-1 gap-8 px-4 py-12 md:px-6 md:py-16 lg:grid-cols-[1fr_300px] lg:gap-12 lg:px-8 lg:py-20">
          <div className="w-full p-2 bg-[rgba(225,225,225,0.1)] rounded-xl">
            <div className="w-full p-4 flex flex-row justify-between items-center border-b-3 dark:border-b-slate-700 border-b-slate-300">
              <div className="flex flex-col text-left">
                ...
                <Breadcrumb>
                  <BreadcrumbList>
                    <BreadcrumbItem>
                      <BreadcrumbLink href="/free-resources">
                        Free Resources
                      </BreadcrumbLink>
                    </BreadcrumbItem>
                    <BreadcrumbSeparator />
                    <BreadcrumbItem>
                      <BreadcrumbLink href={`/free-resources/${params.slug}`}>
                        {params.slug}
                      </BreadcrumbLink>
                    </BreadcrumbItem>
                  </BreadcrumbList>
