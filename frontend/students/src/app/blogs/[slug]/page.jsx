    ...
    <div className="flex flex-col min-h-[100dvh]">
      <div className="relative w-full">
        <GetImage
          ...
          height={600}
          width={1920}
          className="aspect-video w-full object-cover h-[400px]"
        />
          ...
          <div className="mx-auto max-w-5xl space-y-2 text-center text-white">
            ...
            <div className="flex items-center justify-center space-x-4 mt-6">
              ...
              <span className="text-sm font-medium">
                Posted {timeAgo(post.publishedAt)}
              </span>
            </div>
          </div>
        </div>
      ...
      <main className="flex-1">
        <div className="max-w-7xl mx-auto grid grid-cols-1 gap-8 px-4 py-12 md:px-6 md:py-16 lg:grid-cols-[1fr_300px] lg:gap-12 lg:px-8 lg:py-20">
